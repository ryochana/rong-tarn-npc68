...
function categorizeFood(menu) {
    ...
    // คำที่บ่งบอกของคาว (มีความสำคัญสูง)
    const savoryKeywords = [
        'ข้าว', 'ก๋วยเตี๋ยว', 'บะหมี่', 'ขนมจีน', 'ผัดไทย', 'ผัด', 'ทอด', 'ย่าง', 'ปิ้ง',
        'แกง', 'ต้ม', 'น้ำ', 'ซุป', 'แกงเขียวหวาน', 'แกงส้ม', 'แกงไก่', 'แกงเผ็ด',
        'ส้มตำ', 'ลาบ', 'น้ำตก', 'ไส้กรอก', 'หมูปิ้ง', 'ไก่ย่าง', 
        'เนื้อ', 'หมู', 'ไก่', 'ปลา', 'กุ้ง', 'ปู', 'หอย', 'ไข่',
        'จอก', 'คอหมู', 'หมูสะเต๊ะ', 'ไก่ทอด', 'ปลาทอด'
    ];
    
    // เช็คของคาวก่อน (มีความสำคัญสูงกว่า)
    const hasSavory = savoryKeywords.some(keyword => menuLower.includes(keyword));
    if (hasSavory) return 'คาว';
    
    // คำที่บ่งบอกของหวาน (เฉพาะที่ไม่มีของคาวนำหน้า)
    const pureSweatKeywords = [
        'ไอศกรีม', 'ไอติม', 'เจลาโต้', 'โซดา', 'น้ำหวาน', 
        'ชา', 'กาแฟ', 'เครื่องดื่ม', 'นม', 'โกโก้', 'ช็อกโกแลต',
        'คุกกี้', 'มาการอง', 'บราวนี่', 'ทาร์ต', 'พุดดิ้ง', 'มูส',
        'โดนัท', 'ครัวซองต์', 'ขนมปัง', 'เบเกอรี่', 'ฟัดจ์', 'เค้ก',
        'ทองหยิบ', 'ฝอยทอง', 'ทองหยอด', 'บัวลอย', 'ข้าวต้มมัด', 
        'ข้าวหลาม', 'ลูกกอล์ฟ', 'ยาง'
    ];
    
    // เช็คขนม แต่ต้องไม่ใช่ขนมจีน
    if (menuLower.includes('ขนม') && !menuLower.includes('ขนมจีน')) {
        return 'หวาน';
    }
    
    return pureSweatKeywords.some(keyword => menuLower.includes(keyword)) ? 'หวาน' : 'คาว';
}
